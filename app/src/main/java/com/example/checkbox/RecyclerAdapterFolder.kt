 ...
 * @desc
 */
class RecyclerAdapterFolder(val context: FragmentActivity?, var list: ArrayList<thumbnailData>, val fragmentNum: Int, val itemClick: (thumbnailData) -> Unit) :
        RecyclerView.Adapter<RecyclerAdapterFolder.Holder>()
{
